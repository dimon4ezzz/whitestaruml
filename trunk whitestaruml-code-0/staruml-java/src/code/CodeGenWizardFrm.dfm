object CodeGenWizardForm: TCodeGenWizardForm
  ...
  object CodeGenWizard: TJvWizard
    ...
    object SelectRootElemPage: TJvWizardInteriorPage
      ...
      Header.Subtitle.Text = 'Select the starting package for Java code generation.'
    ...
    object SelectElemPage: TJvWizardInteriorPage
      ...
      Header.Title.Font.Style = [fsBold]
      Header.Subtitle.Color = clNone
      Header.Subtitle.Text = 'Select elements to generate by Java code.'
      Header.Subtitle.Anchors = [akLeft, akTop, akRight, akBottom]
      Header.Subtitle.Indent = 20
      Header.Subtitle.Font.Charset = ANSI_CHARSET
      Header.Subtitle.Font.Color = clWindowText
    ...
    object SetOptionPage: TJvWizardInteriorPage
      ...
      object EditingGroup: TGroupBox
        ...
        Caption = ' Code Style '
        TabOrder = 1
        object BraceAtNewLineCheckBox: TCheckBox
          Left = 16
          Top = 28
          Width = 257
          Height = 17
