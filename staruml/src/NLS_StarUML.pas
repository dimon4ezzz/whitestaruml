...
const
  ...
  // TagEdtFrm
  C_TXT_TITLE_TAGGED_VALUE_EDITOR_FORM = 'Tagged Value Editor';
...
var
  ...
  TXT_TITLE_TAGGED_VALUE_EDITOR_FORM: string;
...
initialization
  ...
  NLSManager.TranslateString(NLS_STR_SECTION, 'TXT_TITLE_TAGGED_VALUE_EDITOR_FORM', TXT_TITLE_TAGGED_VALUE_EDITOR_FORM, C_TXT_TITLE_TAGGED_VALUE_EDITOR_FORM);
