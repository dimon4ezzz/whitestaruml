...
uses
  ...
  PieFrm in 'PieFrm.pas' {PieForm},
  DirectMDADlg in 'DirectMDADlg.pas' {GeneratorApplication: CoClass},
  TaskInfoFrm in 'TaskInfoFrm.pas' {TaskInformationForm},
  BatchFrm in 'BatchFrm.pas' {BatchFrame: TFrame},
  PreviewFrm in 'PreviewFrm.pas' {PreviewForm},
  BatchRegisterFrm in 'BatchRegisterFrm.pas' {BatchRegisterForm},
  BatchSelFrm in 'BatchSelFrm.pas' {BatchSelectionForm},
  TemplateRegFrm in 'TemplateRegFrm.pas' {TemplateRegisterForm},
  ProfileSelFrm in 'ProfileSelFrm.pas' {ProfileSelectorForm},
