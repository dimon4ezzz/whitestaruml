...
const
  ...
  C_TXT_CODE_GEN_CANCEL = 'C++ code generation has been canceled.';
  ...
  C_ERR_INVALID_OPTION = 'The option item has not been defined or wrong.'
    + #13#10 + '(%s - %s)';
  C_ERR_TAG_DEFINITION_NOT_DEFINED = '"%s" tag has not been defined in the profile "%s".';
  ...
  C_ERR_CODE_GEN_ERROR2 = 'Error occurred in the process of generating a code.'
    + #13#10 + 'message : %s';
  C_ERR_CANNOT_CREATE_DIRECTORY = 'Cannot create the directory.' + #13#10 + '%s';
  C_ERR_INVALID_DELEGATE = 'There is a Class which is not fit to type of the delegate.(%s)';
  C_ERR_PARAMETR_TYPE_NOT_DEFINED = 'The type of the parameter "%s" has not defined.';
...
var
  ...
  ERR_PARAMETR_TYPE_NOT_DEFINED: string;
  ERR_CODE_GEN_ERROR: string;
  ERR_CODE_GEN_ERROR2: string;
  ERR_INVALID_DELEGATE: string;
  ERR_CANNOT_CREATE_DIRECTORY: string;
...
initialization
  ...
  NLSManager.TranslateString(NLS_STR_SECTION, 'ERR_PARAMETR_TYPE_NOT_DEFINED', ERR_PARAMETR_TYPE_NOT_DEFINED, C_ERR_PARAMETR_TYPE_NOT_DEFINED);
  ...
  NLSManager.TranslateString(NLS_STR_SECTION, 'ERR_INVALID_DELEGATE', ERR_INVALID_DELEGATE, C_ERR_INVALID_DELEGATE);
  NLSManager.TranslateString(NLS_STR_SECTION, 'ERR_CANNOT_CREATE_DIRECTORY', ERR_CANNOT_CREATE_DIRECTORY, C_ERR_CANNOT_CREATE_DIRECTORY);
