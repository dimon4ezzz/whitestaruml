...
const
  ...
  OPTION_PROPERTY_ACCESSORS_SINGLE_LINE = 'PROPERTY_ACCESSORS_SINGLE_LINE';
  OPTION_GENERATE_UTF8 = 'GENERATE_UTF8';
  OPTION_SPACE_MAGNITUDE = 'SPACE_MAGNITUDE';
  OPTION_HEADER_COMMENT = 'HEADER_COMMENT';
  OPTION_GENERATE_OPERATION_IMPLEMENTATION = 'GENERATE_OPERATION_IMPLEMENTATION';
