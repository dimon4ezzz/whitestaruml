...
uses
  Dialogs,
  Classes, SysUtils, WSGenerator_TLB;
type

  PTextTranslatorEngine = class
  private
...
procedure PTextTranslatorEngine.Abort;
begin
end;

constructor PTextTranslatorEngine.Create;
begin
...
function PTextTranslatorEngine.Execute(Args: IHashTable):Boolean;
begin
